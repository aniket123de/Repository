...
export const TeamSection = () => {
  ...
  useEffect(() => {
    ...
    );  }, [isLoaded]);  // Function to get campus ambassador image
  const getCampusAmbassadorImage = (name: string): string | undefined => {    const imageMap: { [key: string]: string } = {
      ...
      "Anish Bar": "/ca/IMG_20240214_131832_356~3 - Anish Bar.jpg",
      "Kunal Das": "/ca/IMG_20250710_003353 - Kunal Das.jpg",
      "Snigdho Bachar": "/ca/IMG_20250606_110513_570 - Snigdho_SOF Chanakya.jpg",
      "Soumyadeep Sarkar": "/ca/IMG_20250402_192115 - Soumyadeep Sarkar.jpg",
